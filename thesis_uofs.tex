...
\chapter{Existing Morphological Descriptors for Root Systems}\label{chap:existing_descriptors}

  \include{./Cs/c1/background}
  \include{./Cs/c1/existed_descriptors}
  \include{./Cs/c1/problem_statement}
  
  
%%%%%%%%%%%%%%%%%%%%%%%%%% CHAPTER 2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\chapter{An Alternative Mathematical Method for Shape Description}\label{chap:math_methods}
  
  \include{./Cs/c2/research_inspiration}
  \include{./Cs/c2/research_methodologies}
  \include{./Cs/c2/sample_size_dkw}
  \include{./Cs/c2/output_analysis}

  %\include{./Cs/c2/Stochastic_Process}
   %\include{./Cs/c2/kac_idea}
   %\include{./Cs/c2/heat_content}
   %\include{./Cs/c2/MC_heat_content}
   %\include{./Cs/c2/MC_d_R}
...
\chapter{LRWs in Artificial Images}
  ...
  \include{./Cs/c3/branchs_R}
  \include{./Cs/c3/branchs_n_d}
  
  %\include{./Cs/c3/branchs_n}  
  %\include{./Cs/c3/branchs_d}
  
  %\include{./Cs/c3/branchs_conclusion}
