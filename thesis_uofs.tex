...
\chapter{An Alternatively Mathematical Method for Shape Description} 
  ...
  \input{chapters/c2/s3_monte_carlo_simulations/subs1_background} % subsection 1
      \input{chapters/c2/s3_monte_carlo_simulations/subs1_subs1_numerical_methods}
      \input{chapters/c2/s3_monte_carlo_simulations/subs1_subs2_probabilistic_interpretation}
      \input{chapters/c2/s3_monte_carlo_simulations/subs1_subs3_monte_carlo_simulation}


  \input{chapters/c2/s3_monte_carlo_simulations/subs2_algorithm_of_random_walks} % subsection 2
      

  \input{chapters/c2/s3_monte_carlo_simulations/subs3_output_analysis} % subsection 3
      \input{chapters/c2/s3_monte_carlo_simulations/subs3_subs2_km_estimator}
      \input{chapters/c2/s3_monte_carlo_simulations/subs3_subs3_confidence_interval}
      \input{chapters/c2/s3_monte_carlo_simulations/subs3_subs1_scaling_relationship}

  \input{chapters/c2/s3_monte_carlo_simulations/subs4_sample_size_determination} % subsection 4
      \input{chapters/c2/s3_monte_carlo_simulations/subs4_subs1_general_method}
      \input{chapters/c2/s3_monte_carlo_simulations/subs4_subs2_dkw_inequlity}
...
%\chapter{Fixed-time Step Monte Carlo Simulations on Artificial Images}
  ...
  %\input{chapters/c3/s2_methodology_validation/subs1_statistical_fluctuation_analysis.tex} % subsection 1
  %\input{chapters/c3/s2_methodology_validation/subs2_sample_size_determination_and_evaluation.tex} % subsection 2
  %\input{chapters/c3/s2_methodology_validation/subs3_conclusion.tex} % subsection 3
